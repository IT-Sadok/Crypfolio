...
namespace Crypfolio.Infrastructure.Migrations
{
    ...
    [Migration("20250624151332_SyncBinanceAccount_AddAssetsSupport")]
    partial class SyncBinanceAccount_AddAssetsSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crypfolio.Domain.Abstract.AccountSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AccountSource");

                    b.HasDiscriminator<string>("AccountType").HasValue("AccountSource");
            ...
            modelBuilder.Entity("Crypfolio.Domain.Entities.ExchangeAccount", b =>
                {
                    b.HasBaseType("Crypfolio.Domain.Abstract.AccountSource");
            ...
            modelBuilder.Entity("Crypfolio.Domain.Entities.Asset", b =>
                {
                    b.HasOne("Crypfolio.Domain.Abstract.AccountSource", null)
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Crypfolio.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("Crypfolio.Domain.Abstract.AccountSource", "AccountSource")
